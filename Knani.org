...
** Look and feel
   ...
   #+BEGIN_SRC emacs-lisp
     (set-frame-font
      "-misc-fixed-medium-r-normal--14-130-75-75-c-70-iso10646-1" nil t)
   #+END_SRC
...
** Org capture
   ...
   #+BEGIN_SRC emacs-lisp
     (add-to-list 'org-capture-templates `("P" "Password" entry (file "~/passwords.org.gpg")
   ...
   #+BEGIN_SRC emacs-lisp
     (add-to-list 'org-capture-templates `("j" "Journal" entry (file+olp+datetree "~/org/journal.org")
					   "* %?\nEntered on %U\n  %i\n  %a"))
   #+END_SRC
...
** Org passwords
   ...
   #+BEGIN_SRC emacs-lisp
     (setq org-passwords-file "~/passwords.org.gpg")
   #+END_SRC
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (defun flip-theme ()
	   ...
	   (progn
	     ...
	     (load-theme dark-theme)
	     (set-frame-font "-misc-fixed-medium-r-normal--14-130-75-75-c-70-iso10646-1" nil t))
	 (progn
	   (disable-theme dark-theme)
	   (custom-set-faces
	    '(default ((t (:height 123 :stipple nil :background nil :foreground nil :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :width normal :family "DejaVu Sans Mono")))))
